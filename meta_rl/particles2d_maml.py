...
parser = argparse.ArgumentParser(description='MAML for Particles2D')
...
def main():
    ...
    with open("logs/args_particles2d_maml_" + time_start + ".txt", "w") as f:
    ...
    for iteration in range(num_iterations):
        ...
        if iteration % log_int == 0:
            ...
            torch.save(policy.state_dict(), "logs/model_particles2d_maml_" + time_start + ".pt")
            np.save("logs/log_particles2d_maml_" + time_start, log_ar)

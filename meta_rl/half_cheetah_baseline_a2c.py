...
parser = argparse.ArgumentParser(description='HalfCheetah for baseline - A2C')
...
def main():
    ...
    with open("logs/args_half_cheetah_a2c_" + time_start + ".txt", "w") as f:
    ...
    torch.save(policy.state_dict(), "logs/model_half_cheetah_a2c_" + time_start + ".pt")
    np.save("logs/log_half_cheetah_a2c_" + time_start, log_ar)

...
def main():
    ...
    with open("logs/args_particle2d_maml_" + time_start + ".txt", "w") as f:
    ...
    for iteration in range(num_iterations):
        ...
        if iteration % log_int == 0:
            ...
            torch.save(policy.state_dict(), "logs/model_particle2d_maml_" + time_start + ".pt")
            np.save("logs/log_particle2d_maml_" + time_start, log_ar)
